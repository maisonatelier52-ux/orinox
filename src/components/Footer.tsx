        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
          ...
          <motion.div {...anim(0.35)} className="grid grid-cols-2 md:grid-cols-3 gap-x-12 lg:gap-x-32 gap-y-8 text-white">
            ...
            <div className="flex flex-col space-y-3">
              <Link href="/orinox-oil-gas-drilling-infrastructure" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">About</Link>
