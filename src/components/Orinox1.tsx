    ...
    <section className="min-h-screen w-full bg-black px-6 py-10 md:px-20 md:pt-20 text-white">
      <div className="max-w-[1100px] ">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-15 md:gap-0">
          ...
          <button className="rounded-md border cursor-pointer border-white/60 px-6 md:px-10 py-3 text-[13px] md:text-[12px] md:text-[13px] font-medium whitespace-nowrap">
            Technical Solutions
          </button>
          </Link>
        </div>
        ...
        {/* Menu */}
        {/* Menu */}
        <div className="mt-20 md:mt-40 text-[13px] md:text-[12px]">
        ...
        <div className="mt-16 flex flex-col sm:flex-row justify-end gap-4">
          <a
            href="/pdf/orinox.pdf"
            className="text-center rounded-md border border-white/60 px-6 py-2 text-[13px] md:text-[12px] font-light hover:border-white transition"
            download
          >
            Download Orinox
          </a>
          ...
          <a
            href="/home"
            className="text-center rounded-md px-6 py-2 text-[13px] md:text-[12px] font-medium text-white border border-white/60 transition"
          >
            Home
          </a>
        </div>
