...
<div className="absolute inset-0 bg-black/30" />
    ...
    <div className="absolute bottom-70 md:bottom-25 -translate-y-1/2 left-10 sm:left-10 lg:left-25 z-20 space-y-5 max-w-xs sm:max-w-md lg:max-w-xl text-white flex flex-col">  
          <div>
