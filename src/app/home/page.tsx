      ...
      */}
      ...
      <section className="relative min-h-screen w-full overflow-hidden block py-20 px-6 md:px-32">
        ...
        <div className="relative z-20 max-w-5xl text-white flex flex-col h-full justify-center">
          ...
          <motion.div {...anim(0.4)}>
            <Link href="/login"><Link href="/login"><button className="px-10 py-3.5 border rounded-[5px] border-white/60 text-[11px] font-medium uppercase tracking-[0.15em] hover:bg-white hover:text-black transition-all duration-300">
              Know More
            </button></Link></Link>
          </motion.div>
        </div>
