...
After a discovery, Orinox conducts appraisal drilling and testing to determine the field’s size and commercial viability.     </p>
         ...
         <div>
        <p className="text-[13px] md:text-[12px] text-white/60 leading-tight">Services include drilling appraisal wells, performing well logs and extended well flow tests, coring and fluid sampling, and reservoir characterization studies. Our reservoir engineers build dynamic models to estimate reserves and optimal development plans.</p>  </div> 
        <div>
        <p className="text-[13px] md:text-[12px] text-white/60 leading-tight">
