    ...
    return (
        <div className="flex flex-col bg-black overflow-hidden min-h-screen">
                ...
                <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 6.2, ease: [0.19, 1, 0.22, 1] }}
                ...
                <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="w-full lg:w-2/5 relative">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 5.5, ease: [0.19, 1, 0.22, 1] }}
            ...
            <footer className="relative min-h-screen md:h-screen w-full bg-black overflow-auto md:overflow-hidden px-6 md:px-32 pt-12 flex flex-col justify-between border-t border-white/10">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
                        ...
                        <motion.div {...anim(0.35)} className="grid grid-cols-2 md:grid-cols-3 gap-x-12 lg:gap-x-32 gap-y-8 text-white">
                            ...
                            <div className="flex flex-col space-y-3">
                                ...
                                <Link href="/" className="text-[13px] hover:text-white/60 transition-colors">Insights</Link>
                            </div>
                            {/* Col 2 */}
                            <div className="flex flex-col space-y-3">
                                ...
                                <Link href="/" className="text-[13px] hover:text-white/60 transition-colors">Case Studies</Link>
                                <Link href="/" className="text-[13px] hover:text-white/60 transition-colors">Contact</Link>
                            </div>
                            {/* Col 3 */}
                            <div className="flex flex-col space-y-3">
                                <Link href="/" className="text-[13px] hover:text-white/60 transition-colors">Operations</Link>
                                <Link href="/esg" className="text-[13px] hover:text-white/60 transition-colors">ESG</Link>
                                <Link href="/" className="text-[13px] hover:text-white/60 transition-colors">Team</Link>
                            </div>
                        </motion.div>
                    </div>
                </div>

                {/* Global Offices Section (Optional - mirrored from regions for consistency) */}
                <div className="relative z-20 mt-12 md:mt-16">
                    <motion.h4 {...anim(0.5)} className="text-[14px] font-bold tracking-widest text-white mb-6 md:mb-8 uppercase">GLOBAL OFFICES</motion.h4>
                ...
                {/* Bottom Bar */}
                <div className="relative z-20 py-8 border-t border-white/20 mt-12">
