    ...
    <main className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute top-8 right-10 md:right-16 z-20 flex items-center gap-3">
        ...
        />
         ...
         <div className="absolute top-140 md:top-1/2 -translate-y-1/2 left-10 space-y-5 sm:left-10 lg:left-25 z-20  max-w-xs sm:max-w-md lg:max-w-xl text-white flex flex-col">    
   <div>
